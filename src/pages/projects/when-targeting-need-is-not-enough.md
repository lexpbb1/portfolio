...
But identifying **where need is greatest** is not the same as identifying **where a particular intervention will produce the greatest additional benefit**, or what kind of support a place needs first.

This project examines a potential failure mode in place-based policy: funding can be accurately targeted at lagging outcomes while being misallocated relative to the mechanism, timing or intervention most likely to improve them. A programme may arrive after problems have become more entrenched and costly, or before the local institutions needed to deliver it are ready. It may fund visible activity while overlooking cheaper lead indicators and preventive opportunities earlier in the theory of change.
...
The evidence broadly supports the central concern, but with two important qualifications.

First, the strongest conclusion is not that prevention is *always* cheaper or more effective. Comparative cost-effectiveness evidence is too limited across many sectors to sustain that claim.

Second, replacing lagging outcomes with a predictive score is not a complete solution. Some of the local conditions that determine effectiveness are difficult to observe in administrative data.
...
Crucially, early use of health services sometimes increased before hospitalisations subsequently fell. A monitoring system focused only on current service use could therefore misread productive early engagement as deteriorating performance. [Institute for Fiscal Studies](https://ifs.org.uk/publications/short-and-medium-term-effects-sure-start-childrens-outcomes)

The Early Intervention Youth Fund illustrates the corresponding uncertainty. Its evaluation found no definitive reduction in serious youth violence within the available period, although it reported improvements in some precursor offences and protective factors. This may represent an intervention whose final outcomes had not yet materialised—but the design and evaluation limitations mean that this cannot simply be assumed. [Home Office](https://www.gov.uk/government/publications/evaluation-of-the-early-intervention-youth-fund-impact-report/evaluation-of-the-early-intervention-youth-fund-impact-report)
...
Research commissioned by the National Lottery Heritage Fund comes unusually close to the allocation question. It concluded that prioritisation had been too dependent on data measures and should consider “potential” alongside need.
...
The What Works Centre for Local Economic Growth screened more than 1,000 broadband evaluations; only 16 met its minimum causal standards. Most reported positive local effects, but the effects varied across industries, workers and places and were not necessarily large.
...
Rather than choosing between need and effectiveness, place investment can treat them as distinct dimensions.

| Need | Readiness and opportunity | Appropriate response |
|---|---|---|
| High | High | Fund delivery and evaluate impact |
| High | Low | Fund capacity, engagement and barrier removal first |
| Lower | High | Consider preventive or demonstrator investment where expected marginal return is strong |
| Lower | Low | Monitor, redesign or decline |

A practical decision process would contain six stages:

1. **Equity floor:** use deprivation and lagging outcomes to identify legitimate need and protect distributional objectives.
2. **Mechanism test:** identify the modifiable factor causing or maintaining the outcome.
3. **Readiness assessment:** examine delivery institutions, workforce, partnerships, accessibility and demand.
4. **Marginal-value assessment:** consider additional benefit, cost, deadweight, displacement and time to impact.
